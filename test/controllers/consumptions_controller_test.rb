...
class ConsumptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumption" do
    assert_difference('Consumption.count') do
      post consumptions_url, params: { consumption: { datetime: @consumption.datetime, desciption: @consumption.desciption, feeling_score: @consumption.feeling_score, win: @consumption.win } }
    end
  ...
  test "should update consumption" do
    patch consumption_url(@consumption), params: { consumption: { datetime: @consumption.datetime, desciption: @consumption.desciption, feeling_score: @consumption.feeling_score, win: @consumption.win } }
