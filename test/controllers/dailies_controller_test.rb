...
class DailiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily" do
    assert_difference('Daily.count') do
      post dailies_url, params: { daily: { date: @daily.date, done: @daily.done, habit: @daily.habit } }
    end
  ...
  test "should update daily" do
    patch daily_url(@daily), params: { daily: { date: @daily.date, done: @daily.done, habit: @daily.habit } }
