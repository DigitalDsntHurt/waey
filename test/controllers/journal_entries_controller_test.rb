...
class JournalEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal_entry" do
    assert_difference('JournalEntry.count') do
      post journal_entries_url, params: { journal_entry: { content: @journal_entry.content, prompt_id: @journal_entry.prompt_id } }
    end
  ...
  test "should update journal_entry" do
    patch journal_entry_url(@journal_entry), params: { journal_entry: { content: @journal_entry.content, prompt_id: @journal_entry.prompt_id } }
