...
class SleepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sleep" do
    assert_difference('Sleep.count') do
      post sleeps_url, params: { sleep: { date: @sleep.date, hrs: @sleep.hrs, mins: @sleep.mins, total_hrs: @sleep.total_hrs, total_mins: @sleep.total_mins } }
    end
  ...
  test "should update sleep" do
    patch sleep_url(@sleep), params: { sleep: { date: @sleep.date, hrs: @sleep.hrs, mins: @sleep.mins, total_hrs: @sleep.total_hrs, total_mins: @sleep.total_mins } }
